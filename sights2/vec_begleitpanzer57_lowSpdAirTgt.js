...
// horizontal
for (let l of [
	{ toX: getAirLdn(1), biasY: 0 },
	{ toX: getAirLdn(1), biasY: 0.1 },
	{ toX: getAirLdn(1), biasY: 0.15 },
]) {
	sight.add(new Line({
...
// vertical
for (let l of [
	{ toY: -getAirLdn(0.5), biasX: 0 },
	{ toY: -getAirLdn(0.5), biasX: 0.1 },
	{ toY: -getAirLdn(0.5), biasX: 0.2 },
]) {
	sight.add(new Line({
...
sight.add(new Circle({
	segment: [45 - 30, 45 + 30], diameter: getAirLdn(1) * 2, size: 4.8
}).withMirroredSeg("xy"));
sight.add(new TextSnippet({
	text: `4/4 - ${assumedAirTgtSpd} kph`,
	pos: [getAirLdn(1) - 1.5, -0.4],
	align: "left", size: 1.6
}));
// 3/4
...
// 2/4
sight.add(new Circle({
	segment: [2, 358], diameter: getAirLdn(0.5) * 2, size: 3
}));
sight.add(new TextSnippet({
