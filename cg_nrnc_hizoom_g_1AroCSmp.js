...
import * as preDef from "./_lib/sight_predefined_info.js"




let sight = new comp.Sight();
...
//// Basic Settings ////
sight.append(preDef.basicVars.sizeScales.getHighZoom({line: LINE_WIDTH})).append("")
sight.append(preDef.basicVars.colors.getGreenRed()).append("")

sight.append(preDef.basicVars.buildDistanceValuePos([-0.175, 0.035]))
sight.append(preDef.basicVars.buildRgfdPos([110, -0.02425]))
sight.append(preDef.basicVars.buildDetectAllyPos([110, -0.045]))
sight.append(preDef.basicVars.buildShellDistanceTickVars(
...
sight.append(preDef.basicVars.getMiscCommonVars()).append("")
...
sight.append((new comp.ShellDistancesBlock()).
	add(400).add(800).
	add(2000, 20, [0.0035,0.007]).
	add(4000, 40, [0.0035,0.007]).
	addMax().getCode()
).append("")
